...
void STEP_PB6600(){
  // Set the direction (HIGH or LOW) based on your motor's desired direction
  digitalWrite(DIR_PIN, HIGH); // Set to HIGH for one direction, LOW for the other

  // Generate pulses to rotate the motor at high speed
